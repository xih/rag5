    ...
    Tables: {
      parcels: {
        Row: {
          ...
          date_map_add: string | null
          date_map_alt: string | null
          date_map_drop: string | null
          date_rec_add: string | null
          date_rec_drop: string | null
          from_address_num: number | null
          in_asr_secured_roll: boolean | null
          lot_num: string | null
          mapblklot: string
          numbertext: string | null
          odd_even: string | null
          planning_district: string | null
          planning_district_number: number | null
          police_company: string | null
          police_district: string | null
          project_id_add: string | null
          project_id_alt: string | null
          project_id_drop: string | null
          pw_recorded_map: boolean | null
          shape: string | null
          shape_geojson: Json | null
          street_name: string | null
          street_type: string | null
          supdist: string | null
          supdistpad: string | null
